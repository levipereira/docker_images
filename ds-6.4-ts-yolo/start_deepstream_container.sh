...
# Script to run the Docker container for Deepstream with YOLOv9 model support served by Triton Server.
...
# -v $(pwd)\videos:/deepstream_python_apps/apps/deepstream-yolov9-triton-server-rtsp-out/videos: Mount the local videos directory to the container.
